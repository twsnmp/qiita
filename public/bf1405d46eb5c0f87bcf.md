---
title: GO言語のgo-echartsパッケージを使ってヒートマップを出力する方法
tags:
  - Go
  - グラフ
  - チャート
  - ECharts
private: false
updated_at: '2024-09-18T15:51:13+09:00'
id: bf1405d46eb5c0f87bcf
...
func main() {
	...
	hm.AddSeries("heatmap", genHeatMapData())

	f, _ := os.Create("heatmap.html")
	hm.Render(f)
}

```

 のようなプログラムで出力できます。結果は

 ![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/3874862/59dffdd3-f1b2-9d2f-2492-73adfd6ff5ed.png)
...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/3874862/1a713522-9471-3eb3-382e-167ad1f98201.png)

の位置です。Y軸は上へ、X軸は、右へいくほど大きくなります。
...
のソフトの中で曜日と時間帯や日付と時間帯のログの件数を表現するために使っています。

X軸とY軸を変更すれば、

![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/3874862/d9f08973-d791-8ada-3aa2-fa874ed5434e.png)
